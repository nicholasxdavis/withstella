<?php
/**
 * Legacy User Fix Script - Web Version
 * Run this by visiting: http://your-domain.com/legacy_fix.php
 */
...
<body>
    <h1>🔧 Legacy User Fix Script</h1>
    
    <?php if (!isset($_GET['run'])): ?>
        <p>This script will fix legacy users who were created before Nextcloud integration and other recent features.</p>
        <p><strong>What it will do:</strong></p>
        <ul>
            <li>Add missing database columns</li>
            <li>Create missing tables</li>
            <li>Set up Nextcloud credentials for legacy users</li>
            <li>Generate share tokens for existing assets and brand kits</li>
            <li>Add foreign key constraints</li>
        </ul>
        <p><strong>⚠️ Warning:</strong> This will modify your database. Make sure you have a backup!</p>
        <button onclick="window.location.href='?run=1'">Run Fix Script</button>
    <?php else: ?>
        <pre>
<?php
try {
...
?>
        ...
        <p><strong>✅ Fix Complete!</strong></p>
        <p>You can now delete this file for security: <code>legacy_fix.php</code></p>
    <?php endif; ?>
</body>
</html>
